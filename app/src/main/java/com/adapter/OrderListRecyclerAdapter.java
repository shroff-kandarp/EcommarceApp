...
public class OrderListRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OrderListRecyclerAdapter(Context mContext, ArrayList<HashMap<String, String>> list, GeneralFunctions generalFunc, boolean isFooterEnabled) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_FOOTER) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_order_list_design, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            viewHolder.itemNameTxtView.setText(Html.fromHtml(item.get("productName")));
            viewHolder.itemPriceTxtView.setText(item.get("totalPrice"));
//            viewHolder.itemQuantityTxtView.setText("QTY: " + item.get("quantity"));
            viewHolder.itemQTYTxtView.setText("QTY: " + item.get("productQuantity"));
            ...
            if (item.get("orderStatus").equalsIgnoreCase("Processing") || item.get("orderStatus").equalsIgnoreCase("Pending")) {
                viewHolder.cancelArea.setVisibility(View.VISIBLE);
                viewHolder.cancelAreaSeperatorView.setVisibility(View.VISIBLE);
            } else {
                viewHolder.cancelArea.setVisibility(View.GONE);
                viewHolder.cancelAreaSeperatorView.setVisibility(View.GONE);
            }
...
//            Utils.printLog("CCN","::"+item.get("name"));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public View cancelArea;
        public AppCompatImageView itemImgView;
        public View contentArea;
        public View cancelAreaSeperatorView;
        public View qtyArea;
        ...
        public ViewHolder(View view) {
            ...
            cancelAreaSeperatorView = view.findViewById(R.id.cancelAreaSeperatorView);
            cancelArea = view.findViewById(R.id.cancelArea);
